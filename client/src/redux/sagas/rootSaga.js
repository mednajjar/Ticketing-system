...
import { getTicketById,assignTech,getTechnicien,getTicket, getMyTicket, addTicket, techTicket, resolvedTicket } from '../slices/ticketSlice';
import { handelGetTicketById,handelAssignTechnicien,handelGetTechnicien,handelGetTicket, handelGetMyTicket, handelAddTicket, handelTechTicket, handelResolvedTicket} from './handlers/ticket.handler';
